        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DrustvoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dogodek", x => x.ID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cebeljnjak", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Cebeljnjak_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Evidenca", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Evidenca_Panj_PanjId",
                        column: x => x.PanjId,
                        principalTable: "Panj",
                        principalColumn: "PanjID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cebeljnjak_ApplicationUserId",
                table: "Cebeljnjak",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Dogodek_DrustvoId",
                table: "Dogodek",
                column: "DrustvoId");

            migrationBuilder.CreateIndex(
                name: "IX_Evidenca_PanjId",
                table: "Evidenca",
                column: "PanjId");
